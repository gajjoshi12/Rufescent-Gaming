...
export const PROMOTIONS: Promotion[] = [
  {
    ...
    subtitle: "Double your first deposit up to ₹20,000 and start with a bigger bankroll across sports and casino.",
    badge: "New players",
    cta: "Claim bonus",
    href: "/wallet",
    hues: [14, 46],
    terms: "Min deposit ₹500 · 6x wagering at odds 1.60+ · 30 days to complete.",
  },
  {
    id: "pr-cashback",
    ...
    href: "/promotions",
    hues: [196, 232],
    terms: "Calculated on settled bets Mon–Sun · max ₹25,000 per week · paid by 12:00 IST.",
  },
  {
    id: "pr-acca",
    ...
    href: "/sports",
    hues: [268, 306],
    terms: "Min 4 legs at odds 1.30+ each · pre-match and in-play · max boost ₹50,000.",
  },
  {
    id: "pr-spins",
    title: "150 Free Spins on Ember Fortune",
    subtitle: "Deposit ₹1,000 and collect fifty spins a day for three days on our headline progressive slot.",
    badge: "Casino",
    cta: "Spin now",
    href: "/casino",
    hues: [332, 8],
    terms: "Spin value ₹5 · winnings credited as cash · expires 72 hours after issue.",
  },
  {
    id: "pr-fantasy",
    title: "₹50 Lakh Fantasy Mega",
    subtitle: "One entry, one hundred and twenty-eight thousand seats, and a crore-scale prize pool every match day.",
    badge: "Guaranteed",
    cta: "Enter contest",
    href: "/fantasy",
    hues: [146, 178],
    terms: "Entry ₹49 · guaranteed prize pool · multi-entry up to 20 teams per user.",
  },
  {
    id: "pr-referral",
    ...
    href: "/wallet",
    hues: [88, 118],
    terms: "Friend must deposit ₹500+ and wager it once · max 10 referrals per account.",
  },
];
...
export const QUICK_STATS: QuickStat[] = [
  ...
  { label: "Payouts processed", value: "₹840Cr", hint: "Withdrawn in the last 12 months" },
